...
{
      -8,     0,    -8,    -7,    -8,    21,    -8,    21,    21,    42,
      -8,    -8,    34,    30,    21,    21,    21,    21,    -8,    -8,
      -8,    -2,    -2,    -8,    -8
};
...
{
       2,     3,    10,     4,    16,    17,     5,     0,     0,     6,
       7,    11,     8,    12,    13,     0,     0,     0,     0,     0,
      21,    22,    23,    24,     4,     0,     0,     5,     0,     0,
       0,     7,     0,     8,    14,    15,    16,    17,    14,    15,
      16,    17,    20,     0,     0,    19,    14,    15,    16,    17,
       0,    18
};
...
{
       0,     1,     9,     3,     6,     7,     6,    -1,    -1,     9,
      10,     5,    12,     7,     8,    -1,    -1,    -1,    -1,    -1,
      14,    15,    16,    17,     3,    -1,    -1,     6,    -1,    -1,
      -1,    10,    -1,    12,     4,     5,     6,     7,     4,     5,
       6,     7,    12,    -1,    -1,    11,     4,     5,     6,     7,
      -1,     9
};
...
{
       0,    14,     0,     1,     3,     6,     9,    10,    12,    15,
       9,    15,    15,    15,     4,     5,     6,     7,     9,    11,
      12,    15,    15,    15,    15
};
...
#line 30 "calc.y"
        ...
        if (!had_error) {  // Only print if there was no error
            if ((yyvsp[-1].num) == (int)(yyvsp[-1].num))  // Check if the result is an integer
                printf("= %d\n", (int)(yyvsp[-1].num));
            else
                printf("= %.1f\n", (yyvsp[-1].num));  // Print with one decimal place
        }
...
#line 1098 "calc.tab.c"
  ...
  case 4: /* calclist: calclist '\n'  */
#line 40 "calc.y"
                         { printf(">  "); }
#line 1104 "calc.tab.c"
    break;

  case 5: /* calclist: calclist error '\n'  */
#line 41 "calc.y"
                          { 
